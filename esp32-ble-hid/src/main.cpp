...
const char* WIFI_SSID = "Ethan iPhone";
// const char* WIFI_PASS = "arihanv1";
const char* WIFI_PASS = "edgcomp123";
...
const int LOGICAL_SCREEN_WIDTH = 390;
const int LOGICAL_SCREEN_HEIGHT = 844;
const int ABS_HOME_SWEEPS = 120;
const int ABS_HOME_DELAY_MS = 12;
const int ABS_STEP_SIZE = 1;
...
const float ABS_MOVEMENT_SCALE = 2.0f;
...
void webSocketEvent(WStype_t type, uint8_t* payload, size_t length) {
  switch (type) {
    ...
    case WStype_CONNECTED: {
      ...
      JsonDocument reg;
      reg["type"] = "register";
      reg["name"] = "sotos-james";
      String regJson;
      serializeJson(reg, regJson);
      webSocket.sendTXT(regJson);
      Serial.println("[WS] Registered as 'sotos-james'");
      break;
    }
